...
const tickerData = [
  { symbol: 'AAPL', price: 178.42, change: 2.4, positive: true },
  { symbol: 'TSLA', price: 242.84, change: 5.2, positive: true },
  { symbol: 'MSFT', price: 378.91, change: 1.8, positive: true },
  { symbol: 'GOOGL', price: 139.45, change: 1.2, positive: true },
  { symbol: 'NVDA', price: 495.22, change: 0.5, positive: true },
  { symbol: 'META', price: 334.57, change: -1.3, positive: false },
  { symbol: 'AMZN', price: 145.33, change: -0.3, positive: false },
];
      ...
      <div className="container mx-auto px-4 py-4 relative z-10">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div>
              <motion.h1 
                className="text-2xl tracking-tight bg-gradient-to-r from-white to-orange-300 bg-clip-text text-transparent"
                animate={{
